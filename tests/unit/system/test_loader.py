...
class TestPersonaLoader:
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('yaml.safe_load')
    def test_load_persona_from_cache(self, mock_yaml_load, mock_file, sample_persona_yaml):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('yaml.safe_load')
    def test_load_persona_force_reload(self, mock_yaml_load, mock_file, sample_persona_yaml):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('yaml.safe_load')
    def test_parse_persona_data_complete(self, mock_yaml_load, mock_file, sample_persona_yaml):
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('yaml.safe_load')
    def test_parse_persona_data_minimal(self, mock_yaml_load, mock_file, minimal_persona_yaml):
    ...
    def test_list_personas_auto_discover(self):
        ...
        with patch.object(loader, 'discover_personas', side_effect=mock_discover) as mock_discover:
            personas = loader.list_personas()
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('yaml.safe_load')
    def test_validate_persona_file_valid(self, mock_yaml_load, mock_file, sample_persona_yaml):
    ...
    def test_validate_persona_file_invalid(self, mock_yaml_load, mock_file):
        ...
        assert any("Missing persona name" in error or "No core principles defined" in error for error in errors)
    ...
    def test_reload_all_success(self, mock_yaml_load, mock_file, sample_persona_yaml):
        ...
        with patch.object(loader, 'discover_personas', return_value=loader._persona_paths):
    ...
    def test_reload_all_with_failures(self, mock_yaml_load, mock_file):
        ...
        mock_yaml_load.side_effect = [
            {"identity": {"name": "Good", "id": "good", "title": "Good", "role": "good"}, "behavioral_contract": {"core_principles": ["Good principle"]}},
...
class TestPersonaLoaderIntegration:
    ...
    def temp_persona_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            override_persona = {
                ...
                "behavioral_contract": {
                    "core_principles": ["Override principles"]
                }
            }
    ...
    def test_full_workflow(self, temp_persona_structure):
        ...
        security_errors = loader.validate_persona_file(src_personas / "security-dev.yaml")
...
class TestPersonaLoaderEdgeCases:
    ...
    def test_concurrent_loading(self):
        ...
        with patch('builtins.open', mock_open()):
            with patch('yaml.safe_load', return_value={"identity": {"name": "Test", "id": "test", "title": "Test", "role": "test"}}):
                loader._persona_paths = {"test": Path("test.yaml")}
    ...
    def test_unicode_content(self):
        ...
        unicode_data = {
            ...
            "behavioral_contract": {
                "core_principles": ["Code propre", "Tests complets", "Documentation claire"]
            }
        }
