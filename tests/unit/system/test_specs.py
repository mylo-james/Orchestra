...
class TestPersonaSpec:
    ...
    def test_persona_spec_complete(self, sample_identity, sample_behavioral_contract, 
                                 sample_command_interface, sample_resource_dependencies, 
    ...
    def test_persona_spec_get_command_direct(self, sample_identity, sample_command_interface):
    ...
    def test_persona_spec_get_command_alias(self, sample_identity):
        ...
        interface = CommandInterface(
            commands={"test_cmd": cmd_def},
            command_aliases={"tc": "test_cmd"}
        )
    ...
    def test_persona_spec_get_command_alias_not_found(self, sample_identity):
        ...
        interface = CommandInterface(
            commands={},
            command_aliases={"broken": "nonexistent"}
        )
        spec = PersonaSpec(identity=sample_identity, command_interface=interface)
    ...
    def test_persona_spec_validate_valid(self, sample_identity, sample_behavioral_contract):
    ...
    def test_persona_spec_to_dict_complete(self, sample_identity, sample_behavioral_contract,
                                         sample_command_interface, sample_resource_dependencies,
                                         sample_knowledge_context):
...
class TestPersonaSpecIntegration:
    ...
    def test_full_persona_workflow(self):
        ...
        dependencies = ResourceDependencies(
            knowledge_sources=["web-dev-docs", "security-guidelines", "performance-guides"],
    ...
    def test_persona_spec_edge_cases(self):
        ...
        spec_dict = spec.to_dict()
        assert len(spec_dict["command_interface"]["commands"]["large_cmd"]["parameters"]) == 100
