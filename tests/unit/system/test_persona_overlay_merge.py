...
class TestOverlayMergeEngine:
    ...
    def team_overlay(self):
        ...
        return PersonaOverlay(
            ...
            modifications={
                ...
                "resource_dependencies": {"tools": ["cypress", "storybook"]},
            },
        )
    ...
    def test_simple_merge_base_only(self, merge_engine, base_persona):
        ...
        result = merge_engine.merge_persona(
            base_persona=base_persona, team_overlay=None, project_overlay=None
        )
    ...
    def test_merge_with_all_overlays(
        self, merge_engine, base_persona, team_overlay, project_overlay
    ):
    ...
    def test_conflict_detection_and_resolution(self, merge_engine, base_persona):
        ...
        final_conflict = result.conflicts[
            -1
        ]  # Last conflict should be the final resolution
    ...
    def test_hot_reload_cache_invalidation(self, merge_engine):
        ...
        # Invalidate cache
        merge_engine.invalidate_cache(
            persona_id="dev", team_id="team1", project_id="proj1"
        )
...
class TestOverlayValidation:
    ...
    def test_validate_overlay_schema(self):
        ...
        valid_overlay = {
            ...
            "persona_id": "dev",
            "modifications": {
                "behavioral_contract": {"core_principles": ["React best practices"]}
            },
        }
    ...
    def test_validate_overlay_conflicts(self):
        ...
        command_conflict = next(
            (c for c in conflicts if "commands.test" in c.field_path), None
        )
...
class TestMergePerformance:
    ...
    def test_merge_performance(self):
        ...
        from orchestra.system.persona_overlay_merge import OverlayType, PersonaOverlay
        from orchestra.system.specs import (
            BehavioralContract,
            CommandInterface,
            PersonaIdentity,
        ...
        team_overlay = PersonaOverlay(
            ...
            persona_id="dev",
            modifications={
                "behavioral_contract": {"core_principles": ["Team practices"]}
            },
        )
        ...
        project_overlay = PersonaOverlay(
            ...
            persona_id="dev",
            modifications={
                "behavioral_contract": {"core_principles": ["Project standards"]}
            },
        )
...
class TestIntegrationScenarios:
    ...
    def test_frontend_team_ecommerce_project_scenario(self):
        ...
        base_dev = PersonaSpec(
            ...
            command_interface=CommandInterface(commands={}),
            resource_dependencies=ResourceDependencies(tools=["git", "docker"]),
        )
        ...
        frontend_overlay = PersonaOverlay(
            ...
            modifications={
                ...
                "resource_dependencies": {"tools": ["webpack", "cypress"]},
            },
        )
        ...
        ecommerce_overlay = PersonaOverlay(
            ...
            modifications={
                ...
                "resource_dependencies": {"tools": ["stripe-cli", "redis-cli"]},
            },
        )
