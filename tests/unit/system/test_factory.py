...
from src.system.specs import PersonaSpec, PersonaIdentity
...
class TestAgentRegistry:
    ...
    def registry(self, mock_persona_loader):
        ...
        with patch('src.system.factory.PersonaLoader', return_value=mock_persona_loader):
    ...
    def test_create_agent_success(self, registry, mock_persona_loader, sample_persona_spec):
        ...
        with patch('src.system.factory.UniversalAgent') as mock_universal_agent:
            ...
            mock_universal_agent.assert_called_once_with(
                persona_id="test-dev",
                persona_spec=sample_persona_spec
            )
    ...
    def test_create_agent_persona_not_found(self, registry, mock_persona_loader):
        ...
        mock_persona_loader.list_personas.return_value = ["dev", "security-dev", "frontend-dev"]
    ...
    def test_get_persona_spec_found(self, registry, mock_persona_loader, sample_persona_spec):
    ...
    def test_create_agent_logging(self, mock_logger, registry, mock_persona_loader, sample_persona_spec):
...
class TestAgentRegistryErrorHandling:
    ...
    def test_create_agent_with_universal_agent_exception(self, registry, mock_persona_loader):
        ...
        with patch('src.system.factory.UniversalAgent', side_effect=Exception("Agent creation error")):
            with pytest.raises(Exception) as exc_info:
                registry.create("test-persona")
    ...
    def test_get_persona_spec_with_loader_exception(self, registry, mock_persona_loader):
...
class TestAgentRegistryEdgeCases:
    ...
    def test_create_agent_with_empty_string_persona_id(self, registry, mock_persona_loader):
    ...
    def test_create_agent_with_whitespace_persona_id(self, registry, mock_persona_loader):
