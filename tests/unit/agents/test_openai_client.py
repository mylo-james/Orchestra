...
from src.agents.base.secure_agent import OpenAIClient, ModelConfig
...
async def test_openai_client_retries_and_returns_content():
    ...
    with patch("src.agents.base.secure_agent.AsyncOpenAI") as mock_cls:
        ...
        mock_instance.chat.completions.create = AsyncMock(side_effect=[Exception("boom"), create_mock()])
