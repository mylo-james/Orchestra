...
class TestValidateAgentOutputActivity:
    ...
    async def test_valid_agent_output(self):
        ...
        params = {
            ...
            "output": {"code": "print('Hello, World!')", "description": "Simple greeting"},
    ...
    async def test_sensitive_data_detection(self):
        ...
        params = {
            "agent_type": "developer",
            "output": {"code": "api_key = 'sk-1234567890abcdef'", "description": "API setup"},
            "context": {"session_id": "session-123"}
        }
    ...
    async def test_dangerous_code_patterns(self):
        ...
        params = {
            "agent_type": "developer",
            "output": {"code": "exec('print(\"Hello\")')", "description": "Dynamic execution"},
            "context": {"session_id": "session-123"}
        }
...
class TestSecurityActivitiesIntegration:
    ...
    @pytest.mark.asyncio
    @patch('src.workflows.security_activities.AIAgentValidator')
