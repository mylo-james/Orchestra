...
class TestBmadInventoryIntegration:
    ...
    def test_scan_real_bmad_agents(self, inventory):
        ...
        expected_agents = [
            "dev.md", "analyst.md", "architect.md", "bmad-master.md",
            "bmad-orchestrator.md", "pm.md", "po.md", "qa.md", 
            "sm.md", "spec.md", "tdd-dev.md", "ux-expert.md"
        ]
    ...
    def test_scan_real_bmad_checklists(self, inventory):
        ...
        for expected in expected_checklists:
            assert expected in checklist_names, f"Expected checklist {expected} not found"
    ...
    def test_convert_real_persona_to_orchestra_schema(self, inventory, conversion_strategy):
    ...
    def test_convert_real_task_to_orchestra_schema(self, inventory, conversion_strategy):
    ...
    def test_metadata_extraction_from_real_files(self, inventory):
        ...
        items_with_metadata = [
            item for item in inventory.content_items 
        ...
        templates = [item for item in inventory.content_items if item.content_type == BmadContentType.TEMPLATE]
