...
from orchestra.system.bmad_inventory import (
...
class TestBmadContentInventory:
    ...
    def mock_bmad_structure(self):
        ...
        return {
            "agents": [
                ...
                "dev.md", "pm.md", "po.md", "qa.md", "sm.md", "spec.md", 
                "tdd-dev.md", "ux-expert.md"
            ],
            "tasks": [
                "create-doc.md", "review-story.md", "implement-from-specs.md",
                "validate-test-coverage.md", "qa-gate.md"
            ],
            "templates": [
                "prd-tmpl.yaml", "story-tmpl.yaml", "architecture-tmpl.yaml",
                "test-spec-tmpl.md"
            ],
            "checklists": [
                "story-dod-checklist.md", "architect-checklist.md", 
                "pm-checklist.md", "tdd-dev-dod-checklist.md"
            ]
        }
    ...
    def test_scan_agents_directory(self, inventory, mock_bmad_structure):
        ...
        with patch.object(inventory, '_scan_directory') as mock_scan:
            ...
            mock_scan.assert_called_once_with(Path(".bmad-core/agents"), BmadContentType.PERSONA)
        ...
        with patch.object(inventory, '_scan_directory') as mock_scan:
            mock_scan.return_value = [
                BmadContentItem(
                    ...
                    version="1.0",
                    metadata={"format": "yaml", "variables": ["project_name", "description"]}
                )
            ]
    ...
    def test_full_inventory_scan(self, inventory):
        ...
        with patch.object(inventory, 'scan_agents') as mock_agents, \
            ...
            mock_checklists.return_value = [Mock(content_type=BmadContentType.CHECKLIST)]
    ...
    def test_generate_inventory_report(self, inventory):
        ...
        inventory.content_items = [
            BmadContentItem(
                name="dev.md", path=Path(".bmad-core/agents/dev.md"),
                content_type=BmadContentType.PERSONA, version="1.0", metadata={}
            ),
            BmadContentItem(
                name="create-doc.md", path=Path(".bmad-core/tasks/create-doc.md"),
                content_type=BmadContentType.TASK, version="1.0", metadata={}
            )
        ]
